...
$(function () {
    ...
    $(".swiper-container")
      ...
      .each(function () {
        ...
        swipers["swiper-" + index] = new Swiper(".swiper-" + index, {
          ...
          mousewheelControl: $t.is("[data-mousewheel]")
  ...
  function openPopup(foo) {
    ...
    $('.popup-wrapper, .popup-content[data-rel="' + foo + '"]').addClass(
      "active"
    );
    ...
    $('.popup-content[data-rel="' + $(this).data("rel") + '"]')
      ...
      .html(
        '<iframe class="embed-responsive-item" src="' +
          $(this).data("src") +
          '?autoplay=1&amp;controls=1&amp;loop=1&amp;modestbranding=1&amp;rel=0&amp;showinfo=0&amp;autohide=0&amp;color=white&amp;iv_load_policy=3&amp;wmode=transparent"></iframe>'
      );
  });
